    ...
    <div>
      <div className="container">
        <div className="columns  ">
          <div class="column is-two-thirds box mt-4 pt-6 pb-6 pr-6 mr-6">
            <div className="is-flex is-align-items-center	">
              <p className="is-size-1 has-text-weight-bold">Crud Operation</p>
              <div className="ml-5">
                <i class="fa-brands fa-react has-text-danger is-size-1 mr-3"></i>
              </div>
              <div>
                <svg
                  className="ml-4 mr-4"
          ...
          <div class="column box mt-4 p-5 ml-4 mb-5">
            <p className="is-size-2 has-text-weight-bold has-text-success">
              Made With
            </p>
            <p className="has-text-link is-size-3 has-text-weight-bold">
              React || Spring || Mysql
            </p>
          </div>
        </div>
